      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="wtt-card p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Player Management</h3>
          ...
          <div className="wtt-card p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Tournament Scheduler</h3>
            <p className="text-muted-foreground">
          ...
          <div className="wtt-card p-6">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Match Tracking</h3>
            <p className="text-muted-foreground">
