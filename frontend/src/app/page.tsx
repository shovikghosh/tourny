    ...
    <div className="space-y-16">
      ...
      <div className="relative overflow-hidden rounded-2xl">
        ...
        >
          <div className="absolute inset-0 flex items-center z-20 px-6 lg:px-8">
            <div className="max-w-2xl backdrop-blur-sm bg-black/50 p-8 rounded-xl shadow-lg animate-fadeIn">
              ...
              <div className="flex gap-4">
                <Link
                  href="/tournaments"
                  className="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90 transition-colors"
                >
                  View Tournaments
                </Link>
                <Link
                  href="/tournaments/new"
                  className="inline-flex items-center rounded-md bg-white px-4 py-2 text-sm font-semibold text-primary hover:bg-white/90 border border-primary transition-colors"
                >
                  Create Tournament
                </Link>
              </div>
      ...
      <div className="space-y-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="wtt-card p-6 hover:shadow-md transition-all duration-300 hover:border-primary/40">
      ...
      {/* CTA section */}
      <div className="bg-card border border-border rounded-2xl p-8 text-center shadow-sm hover:shadow-md transition-all duration-300">
